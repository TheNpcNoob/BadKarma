...
<html lang="en">
  ...
  <body>
    <article>
        ...
        <div>
            <p>Sorry for the inconvenience but we&rsquo;re performing some maintenance at the moment. If you need to you can always <a href="admin@badkarma.tech">contact us</a>, otherwise we&rsquo;ll be back online shortly!</p>
            <p>&mdash; The Team</p>
    ...
    <script>
        const countDown = () => {
            const countDay = new Date('February 25, 2023 00:00:00');
            const now = new Date();
